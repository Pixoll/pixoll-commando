...
export type CommandoInstanceChannel<CanBeNull extends boolean, InGuild extends boolean = boolean> = Exclude<If<InGuild, CommandoGuildTextBasedChannel, CommandoTextBasedChannel | If<CanBeNull, null, never>>, CommandoStageChannel>;
