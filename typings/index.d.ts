...
export class CommandoMessage extends Message {
     ...
     * @param options - Options for the response
     */
    protected editResponse(response?: CommandoMessageResponse, { type, options }?: ResponseOptions):
...
export class Util {
    ...
    static noReplyInDMs(msg: Message): MessageOptions;
    static disambiguation(items: (string | Record<string, string>)[], label: string, property?: string | null): string;
    /**
